$(function () {
    ...
    $('#slider-text1 p').html('1CAFE STEENの特製ブレンドのコーヒー。フルーティーな香りとほのかな甘味。妊婦やカフェインが苦手な方にデカフェもご用意。コーヒーはお持ち帰り用のドリップパックもご用意しております。');
    $('#slider-text2 p').html('1CAFE STEENの特製ブレンドのコーヒー。フルーティーな香りとほのかな甘味。妊婦やカフェインが苦手な方にデカフェもご用意。コーヒーはお持ち帰り用のドリップパックもご用意しております。');
    $('#slider-text3 p').html('1CAFE STEENの特製ブレンドのコーヒー。フルーティーな香りとほのかな甘味。妊婦やカフェインが苦手な方にデカフェもご用意。コーヒーはお持ち帰り用のドリップパックもご用意しております。');
